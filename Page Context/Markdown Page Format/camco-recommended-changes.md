...
```html
<a href="tel:+15095361818" onclick="gtag('event', 'generate_lead', {
...
```html
<a href="mailto:info@CamcoConstruction.net" onclick="gtag('event', 'generate_lead', {
  'event_category': 'contact',
...
```html
<a href="/about/#contact" onclick="gtag('event', 'click', {
  'event_category': 'cta',
...
**Pattern:**
```html
<img src="home-addition-spokane.jpg" 
...
- *Do you handle permits for home additions in Spokane WA?*
- *How long does a home addition take in Spokane?*
- *What is the difference between a structural remodel and a cosmetic remodel?*
- *Do you build decks in Spokane Valley and surrounding areas?*
- *Are you licensed to work in Coeur d'Alene and North Idaho?*
...
- *Do you work with property managers in Spokane WA?*
- *Can you work in occupied commercial spaces?*
- *What is included in a tenant improvement scope?*
- *Are you a prevailing wage contractor in Washington State?*
- *Do you serve Spokane Valley commercial properties?*
